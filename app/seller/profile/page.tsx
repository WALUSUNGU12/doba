      ...
      <div className="flex-1 lg:ml-64 transition-all duration-300">
        ...
        <div className="hidden lg:block bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div>
              ...
              <p className="text-sm text-gray-500">Manage your seller profile and preferences</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500">Manage your personal information and business settings</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                   ...
                   <div className="space-y-1.5">
                      ...
                      <input 
                        ...
                        disabled
                        className="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-lg bg-gray-100 text-gray-500 cursor-not-allowed"
                      />
                   </div>
                   <div className="space-y-1.5">
             ...
             <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                <h2 className="text-lg font-bold text-gray-900 mb-6">Business Preferences</h2>
             ...
             <div className="bg-gray-50 rounded-xl border border-gray-200 p-6">
                ...
                <div className="flex flex-col md:flex-row gap-3">
                   ...
                   <button type="button" className="flex-1 py-2.5 bg-teal-700 text-white rounded-lg text-sm font-semibold hover:bg-teal-600 transition-colors">
                      View Shop Settings
                   </button>
                </div>
             </div>
